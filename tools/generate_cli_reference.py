...
MEANINGS = {
    ...
    "object_types": "Physical object types used to filter candidates before ranking.",
    "scope_objects": "Qualified physical objects forming a hard retrieval/context boundary.",
    ...
    "role": "Semantic role.",
    "roles": "Documented semantic roles used to filter candidates before ranking.",
    "required_fields": "Field names every candidate object must contain.",
