...
| [context](#context) | 6 | Build a bounded context packet, prepare a stable prefix, compare packets, or expand pinned metadata. |
...
```
 ...
 | [`tarel context brief`](#tarel-context-brief) | Summarize one saved context packet for a continuing conversation. |
...
| `--brief` | flag | optional | `False` | Print only compact orientation, coverage, gaps, and continuity identity. |
| `--format` | text; `text`, `json` | optional | `text` | Output format (default: text). |
...
Summarize one saved context packet for a continuing conversation.

**Syntax**

```text
tarel context brief [-h] [--format {text,json}] packet
```
...
| `architecture_required` | [ui/server.py](../src/tarel/ui/server.py#L151) |
| `architecture_scope` | [ui/server.py](../src/tarel/ui/server.py#L155) |
| `architecture_unavailable` | [ui/server.py](../src/tarel/ui/server.py#L457) |
...
| `config_not_found` | [tarel/application.py](../src/tarel/application.py#L2574) |
| `conflicting_annotation_filter` | [annotations/states.py](../src/tarel/annotations/states.py#L19) |
| `conflicting_annotation_samples` | [tarel/application.py](../src/tarel/application.py#L2372) |
| `conflicting_workspace_scope` | [sdk/client.py](../src/tarel/sdk/client.py#L2722), [sdk/client.py](../src/tarel/sdk/client.py#L2742), [sdk/client.py](../src/tarel/sdk/client.py#L2756) |
...
| `duplicate_focus` | [ui/server.py](../src/tarel/ui/server.py#L729) |
| `duplicate_focus_source` | [tarel/application.py](../src/tarel/application.py#L2670) |
...
| `empty_refresh_observation` | [tarel/application.py](../src/tarel/application.py#L718) |
| `empty_zone` | [ui/server.py](../src/tarel/ui/server.py#L867) |
...
| `focus_outside_scope` | [ui/server.py](../src/tarel/ui/server.py#L733) |
| `focus_save_failed` | [focus/store.py](../src/tarel/focus/store.py#L39) |
| `focus_stale` | [tarel/application.py](../src/tarel/application.py#L2654), [focus/core.py](../src/tarel/focus/core.py#L118), [ui/server.py](../src/tarel/ui/server.py#L741) |
...
| `graph_outside_focus` | [tarel/application.py](../src/tarel/application.py#L1942) |
| `graph_outside_scope` | [ui/server.py](../src/tarel/ui/server.py#L856), [ui/server.py](../src/tarel/ui/server.py#L955), [workspaces/scope.py](../src/tarel/workspaces/scope.py#L101), [workspaces/scope.py](../src/tarel/workspaces/scope.py#L308) |
...
| `graph_required` | [ui/server.py](../src/tarel/ui/server.py#L851) |
...
| `invalid_annotation_limit` | [tarel/application.py](../src/tarel/application.py#L2157) |
...
| `invalid_annotation_scope` | [annotations/review.py](../src/tarel/annotations/review.py#L211), [annotations/tasks.py](../src/tarel/annotations/tasks.py#L142), [annotations/tasks.py](../src/tarel/annotations/tasks.py#L151), [tarel/cli.py](../src/tarel/cli.py#L3343) |
...
| `invalid_batch_size` | [tarel/application.py](../src/tarel/application.py#L1822), [retrieval/index.py](../src/tarel/retrieval/index.py#L67), [retrieval/local.py](../src/tarel/retrieval/local.py#L222) |
...
| `invalid_change_report` | [graph/change_store.py](../src/tarel/graph/change_store.py#L70), [graph/change_store.py](../src/tarel/graph/change_store.py#L75), [graph/changes.py](../src/tarel/graph/changes.py#L46), [graph/changes.py](../src/tarel/graph/changes.py#L335), [graph/changes.py](../src/tarel/graph/changes.py#L343), [graph/refresh.py](../src/tarel/graph/refresh.py#L52), [graph/refresh.py](../src/tarel/graph/refresh.py#L54), [graph/refresh.py](../src/tarel/graph/refresh.py#L57), [graph/refresh.py](../src/tarel/graph/refresh.py#L128), [graph/refresh.py](../src/tarel/graph/refresh.py#L132), [graph/refresh.py](../src/tarel/graph/refresh.py#L461), [graph/refresh.py](../src/tarel/graph/refresh.py#L468) |
| `invalid_config` | [tarel/application.py](../src/tarel/application.py#L321), [tarel/application.py](../src/tarel/application.py#L339), [tarel/application.py](../src/tarel/application.py#L361), [tarel/application.py](../src/tarel/application.py#L390), [tarel/application.py](../src/tarel/application.py#L2576), [tarel/application.py](../src/tarel/application.py#L2593), [tarel/application.py](../src/tarel/application.py#L2632), [providers/config.py](../src/tarel/providers/config.py#L286), [providers/config.py](../src/tarel/providers/config.py#L289), [providers/config.py](../src/tarel/providers/config.py#L408) |
...
| `invalid_content_type` | [ui/server.py](../src/tarel/ui/server.py#L1011) |
...
| `invalid_focus_scope` | [tarel/application.py](../src/tarel/application.py#L1931) |
...
| `invalid_grounding_limit` | [sdk/client.py](../src/tarel/sdk/client.py#L1400) |
| `invalid_grounding_scope` | [sdk/client.py](../src/tarel/sdk/client.py#L1311), [sdk/client.py](../src/tarel/sdk/client.py#L1339), [sdk/client.py](../src/tarel/sdk/client.py#L1350), [sdk/client.py](../src/tarel/sdk/client.py#L1461), [sdk/client.py](../src/tarel/sdk/client.py#L1467) |
...
| `invalid_knowledge_scope` | [tarel/application.py](../src/tarel/application.py#L2523), [knowledge/contracts.py](../src/tarel/knowledge/contracts.py#L40), [knowledge/contracts.py](../src/tarel/knowledge/contracts.py#L47), [knowledge/contracts.py](../src/tarel/knowledge/contracts.py#L51), [knowledge/contracts.py](../src/tarel/knowledge/contracts.py#L280), [knowledge/contracts.py](../src/tarel/knowledge/contracts.py#L283), [knowledge/contracts.py](../src/tarel/knowledge/contracts.py#L290), [knowledge/contracts.py](../src/tarel/knowledge/contracts.py#L295), [knowledge/contracts.py](../src/tarel/knowledge/contracts.py#L301), [knowledge/contracts.py](../src/tarel/knowledge/contracts.py#L306), [knowledge/contracts.py](../src/tarel/knowledge/contracts.py#L311) |
| `invalid_knowledge_source` | [tarel/application.py](../src/tarel/application.py#L2039) |
| `invalid_knowledge_state` | [knowledge/contracts.py](../src/tarel/knowledge/contracts.py#L266) |
| `invalid_limit` | [tarel/application.py](../src/tarel/application.py#L1161), [retrieval/index.py](../src/tarel/retrieval/index.py#L353), [tarel/search.py](../src/tarel/search.py#L219) |
...
| `invalid_object_family_mode` | [object_families/application.py](../src/tarel/object_families/application.py#L495), [ui/presentation.py](../src/tarel/ui/presentation.py#L144), [ui/server.py](../src/tarel/ui/server.py#L531) |
...
| `invalid_object_reference` | [tarel/application.py](../src/tarel/application.py#L1710), [tarel/cli.py](../src/tarel/cli.py#L2601), [workspaces/core.py](../src/tarel/workspaces/core.py#L385), [workspaces/scope.py](../src/tarel/workspaces/scope.py#L179) |
...
| `invalid_optional_request` | [ui/server.py](../src/tarel/ui/server.py#L387), [ui/server.py](../src/tarel/ui/server.py#L468), [ui/server.py](../src/tarel/ui/server.py#L471), [ui/server.py](../src/tarel/ui/server.py#L535) |
...
| `invalid_port` | [ui/server.py](../src/tarel/ui/server.py#L1104) |
...
| `invalid_profile_row_limit` | [tarel/application.py](../src/tarel/application.py#L2377), [sqlite/connector.py](../src/tarel/connectors/sqlite/connector.py#L205), [sqlite/connector.py](../src/tarel/connectors/sqlite/connector.py#L377), [sqlserver/connector.py](../src/tarel/connectors/sqlserver/connector.py#L520), [sqlserver/connector.py](../src/tarel/connectors/sqlserver/connector.py#L792), [sources/application.py](../src/tarel/sources/application.py#L250) |
| `invalid_proposal` | [annotations/apply.py](../src/tarel/annotations/apply.py#L74), [annotations/contracts.py](../src/tarel/annotations/contracts.py#L88), [annotations/contracts.py](../src/tarel/annotations/contracts.py#L117), [annotations/contracts.py](../src/tarel/annotations/contracts.py#L120), [annotations/contracts.py](../src/tarel/annotations/contracts.py#L127), [annotations/contracts.py](../src/tarel/annotations/contracts.py#L133), [annotations/contracts.py](../src/tarel/annotations/contracts.py#L138), [annotations/contracts.py](../src/tarel/annotations/contracts.py#L144), [annotations/contracts.py](../src/tarel/annotations/contracts.py#L171), [annotations/contracts.py](../src/tarel/annotations/contracts.py#L188), [annotations/contracts.py](../src/tarel/annotations/contracts.py#L192), [annotations/contracts.py](../src/tarel/annotations/contracts.py#L207), [annotations/contracts.py](../src/tarel/annotations/contracts.py#L215), [annotations/contracts.py](../src/tarel/annotations/contracts.py#L221), [annotations/contracts.py](../src/tarel/annotations/contracts.py#L230), [annotations/contracts.py](../src/tarel/annotations/contracts.py#L233), [tarel/cli.py](../src/tarel/cli.py#L3448), [tarel/cli.py](../src/tarel/cli.py#L3450) |
...
| `invalid_query_request` | [ui/query_tools.py](../src/tarel/ui/query_tools.py#L206), [ui/query_tools.py](../src/tarel/ui/query_tools.py#L381), [ui/query_tools.py](../src/tarel/ui/query_tools.py#L410), [ui/query_tools.py](../src/tarel/ui/query_tools.py#L412), [ui/server.py](../src/tarel/ui/server.py#L488) |
...
| `invalid_request` | [ui/server.py](../src/tarel/ui/server.py#L962), [ui/server.py](../src/tarel/ui/server.py#L967), [ui/server.py](../src/tarel/ui/server.py#L1025), [ui/server.py](../src/tarel/ui/server.py#L1208), [ui/server.py](../src/tarel/ui/server.py#L1229), [ui/server.py](../src/tarel/ui/server.py#L1237), [ui/server.py](../src/tarel/ui/server.py#L1244), [ui/server.py](../src/tarel/ui/server.py#L1253), [ui/server.py](../src/tarel/ui/server.py#L1260), [ui/server.py](../src/tarel/ui/server.py#L1274) |
...
| `invalid_sample_limit` | [tarel/application.py](../src/tarel/application.py#L2370), [sqlite/connector.py](../src/tarel/connectors/sqlite/connector.py#L97), [sqlserver/connector.py](../src/tarel/connectors/sqlserver/connector.py#L345), [sources/application.py](../src/tarel/sources/application.py#L255) |
...
| `invalid_session` | [ui/server.py](../src/tarel/ui/server.py#L1008) |
...
| `invalid_stale_claim` | [graph/refresh.py](../src/tarel/graph/refresh.py#L358) |
...
| `invalid_workspace_scope` | [tarel/cli.py](../src/tarel/cli.py#L1946), [tarel/cli.py](../src/tarel/cli.py#L2003), [tarel/cli.py](../src/tarel/cli.py#L2049), [tarel/cli.py](../src/tarel/cli.py#L2094) |
...
| `knowledge_exists` | [tarel/application.py](../src/tarel/application.py#L2021) |
| `knowledge_graph_outside_workspace` | [tarel/application.py](../src/tarel/application.py#L2537) |
...
| `knowledge_scope_not_found` | [tarel/application.py](../src/tarel/application.py#L2491), [tarel/application.py](../src/tarel/application.py#L2516) |
| `knowledge_source_not_found` | [tarel/application.py](../src/tarel/application.py#L2034) |
| `knowledge_workspace_required` | [tarel/application.py](../src/tarel/application.py#L2482) |
...
| `lineage_required` | [ui/server.py](../src/tarel/ui/server.py#L590) |
...
| `missing_api_key` | [tarel/application.py](../src/tarel/application.py#L459), [tarel/cli.py](../src/tarel/cli.py#L3003), [providers/config.py](../src/tarel/providers/config.py#L126) |
| `missing_config` | [tarel/application.py](../src/tarel/application.py#L2621) |
...
| `missing_focus_sources` | [tarel/application.py](../src/tarel/application.py#L769) |
...
| `object_outside_scope` | [tarel/application.py](../src/tarel/application.py#L1308), [tarel/application.py](../src/tarel/application.py#L1344), [tarel/application.py](../src/tarel/application.py#L1715), [workspaces/scope.py](../src/tarel/workspaces/scope.py#L188) |
| `optional_metadata_too_large` | [ui/optional_metadata.py](../src/tarel/ui/optional_metadata.py#L157) |
| `optional_object_outside_scope` | [ui/optional_metadata.py](../src/tarel/ui/optional_metadata.py#L67), [ui/server.py](../src/tarel/ui/server.py#L378) |
| `partial_refresh_scope` | [tarel/application.py](../src/tarel/application.py#L730) |
...
| `proposal_not_found` | [tarel/cli.py](../src/tarel/cli.py#L3443) |
...
| `read_only` | [ui/server.py](../src/tarel/ui/server.py#L806) |
...
| `refresh_scope_mismatch` | [tarel/application.py](../src/tarel/application.py#L740) |
...
| `request_too_large` | [ui/server.py](../src/tarel/ui/server.py#L1022) |
...
| `route_not_found` | [ui/server.py](../src/tarel/ui/server.py#L704), [ui/server.py](../src/tarel/ui/server.py#L802) |
...
| `schema_not_found` | [workspaces/core.py](../src/tarel/workspaces/core.py#L320), [workspaces/scope.py](../src/tarel/workspaces/scope.py#L318) |
...
| `semantic_import_outside_scope` | [ui/server.py](../src/tarel/ui/server.py#L615) |
...
| `small_domain_values_without_profile` | [tarel/application.py](../src/tarel/application.py#L2382) |
...
| `stale_graph` | [ui/server.py](../src/tarel/ui/server.py#L813) |
...
| `stale_knowledge_reference` | [tarel/application.py](../src/tarel/application.py#L2561) |
...
| `stale_logical_metadata_scope` | [ui/server.py](../src/tarel/ui/server.py#L520) |
...
| `stale_object_family_scope` | [ui/server.py](../src/tarel/ui/server.py#L569) |
| `stale_optional_scope` | [ui/server.py](../src/tarel/ui/server.py#L374) |
...
| `stale_workspace` | [ui/server.py](../src/tarel/ui/server.py#L874) |
...
| `ui_operation_failed` | [ui/server.py](../src/tarel/ui/server.py#L1209) |
| `ui_source_required` | [ui/server.py](../src/tarel/ui/server.py#L840), [ui/server.py](../src/tarel/ui/server.py#L1106) |
...
| `unsupported_capability` | [tarel/application.py](../src/tarel/application.py#L397), [tarel/application.py](../src/tarel/application.py#L2601) |
...
| `unsupported_knowledge_format` | [tarel/application.py](../src/tarel/application.py#L2027) |
...
| `workspace_exists` | [tarel/application.py](../src/tarel/application.py#L825) |
| `workspace_not_found` | [workspaces/store.py](../src/tarel/workspaces/store.py#L65) |
| `workspace_required` | [ui/server.py](../src/tarel/ui/server.py#L822) |
...
| `zone_object_not_found` | [ui/server.py](../src/tarel/ui/server.py#L978) |
...
```python
tarel.context.brief(packet: 'ContextResult | ContextPacketSnapshot | dict[str, object] | str | Path') -> 'ContextBrief'
```
```python
tarel.context.compare(previous: 'ContextResult | ContextPacketSnapshot | dict[str, object] | str | Path', current: 'ContextResult | ContextPacketSnapshot | dict[str, object] | str | Path') -> 'ContextDelta'
```
```python
