...
| `--config` | Path | optional | not set | Private connector configuration. |
| `--include-annotated` | flag | optional | `False` | Re-annotate complete objects instead of filling only missing annotations. |
...
```
 ...
 | [`tarel annotation next`](#tarel-annotation-next) | Return the next scoped annotation task as JSON for the coding agent. |
 ...
 | [`tarel annotation edit`](#tarel-annotation-edit) | Create or update one bounded object or field annotation. |
...
| `--object` | text | optional; repeatable | not set | Selected object references. |
| `--limit` | int | optional | not set | Maximum number of items for this operation. |
| `--include-annotated` | flag | optional | `False` | Plan complete objects instead of filling only missing annotations. |
| `--knowledge` | text; `none`, `scoped` | optional | `none` | Include no automatic documents (default) or resolve matching scopes. |
| `--knowledge-document` | text | optional; repeatable | not set | Include one document explicitly; repeat for more. |
| `--knowledge-workspace` | text | optional | not set | Workspace used to resolve system-scoped documents. |
| `--max-knowledge-characters` | int | optional | `12000` | Knowledge-document character budget. |
...
Return the next scoped annotation task as JSON for the coding agent.
...
| `--namespace, --schema` | text | optional | not set | Namespace/schema filter. |
| `--object` | text | optional; repeatable | not set | Selected object references. |
| `--include-annotated` | flag | optional | `False` | Return a complete-object task instead of a missing-only delta. |
| `--samples` | int | optional | `0` | Maximum requested sample rows; zero disables samples where supported. |
| `--profile-rows` | int | optional | `0` | Row budget for optional profiling. |
| `--include-small-domain-values` | flag | optional | `False` | Explicitly allow small-domain values in ephemeral annotation input. |
| `--config` | Path | optional | not set | Private connector configuration. |
...
Create or update one bounded object or field annotation.
...
| `ambiguous_scope_selector` | [workspaces/scope.py](../src/tarel/workspaces/scope.py#L291) |
| `ambiguous_source_mapping` | [tarel/grounding_application.py](../src/tarel/grounding_application.py#L372) |
| `annotation_complete` | [annotations/tasks.py](../src/tarel/annotations/tasks.py#L121) |
| `annotation_not_found` | [annotations/review.py](../src/tarel/annotations/review.py#L351) |
| `annotation_sample_field_mismatch` | [annotations/tasks.py](../src/tarel/annotations/tasks.py#L210), [annotations/tasks.py](../src/tarel/annotations/tasks.py#L215), [annotations/tasks.py](../src/tarel/annotations/tasks.py#L231) |
| `annotation_sample_target_mismatch` | [annotations/tasks.py](../src/tarel/annotations/tasks.py#L186) |
| `architecture_required` | [ui/server.py](../src/tarel/ui/server.py#L148) |
| `architecture_scope` | [ui/server.py](../src/tarel/ui/server.py#L152) |
| `architecture_unavailable` | [ui/server.py](../src/tarel/ui/server.py#L454) |
...
| `empty_zone` | [ui/server.py](../src/tarel/ui/server.py#L864) |
...
| `focus_outside_scope` | [ui/server.py](../src/tarel/ui/server.py#L730) |
| `focus_save_failed` | [focus/store.py](../src/tarel/focus/store.py#L39) |
| `focus_stale` | [tarel/application.py](../src/tarel/application.py#L2466), [focus/core.py](../src/tarel/focus/core.py#L118), [ui/server.py](../src/tarel/ui/server.py#L738) |
...
| `graph_outside_focus` | [tarel/application.py](../src/tarel/application.py#L1754) |
| `graph_outside_scope` | [ui/server.py](../src/tarel/ui/server.py#L853), [ui/server.py](../src/tarel/ui/server.py#L952), [workspaces/scope.py](../src/tarel/workspaces/scope.py#L101), [workspaces/scope.py](../src/tarel/workspaces/scope.py#L313) |
...
| `graph_required` | [ui/server.py](../src/tarel/ui/server.py#L848) |
...
| `invalid_annotation_limit` | [tarel/application.py](../src/tarel/application.py#L1969) |
| `invalid_annotation_mode` | [annotations/tasks.py](../src/tarel/annotations/tasks.py#L116) |
...
| `invalid_annotation_samples` | [annotations/tasks.py](../src/tarel/annotations/tasks.py#L133), [annotations/tasks.py](../src/tarel/annotations/tasks.py#L147), [annotations/tasks.py](../src/tarel/annotations/tasks.py#L153), [annotations/tasks.py](../src/tarel/annotations/tasks.py#L168), [annotations/tasks.py](../src/tarel/annotations/tasks.py#L179), [annotations/tasks.py](../src/tarel/annotations/tasks.py#L198), [annotations/tasks.py](../src/tarel/annotations/tasks.py#L203), [annotations/tasks.py](../src/tarel/annotations/tasks.py#L220), [annotations/tasks.py](../src/tarel/annotations/tasks.py#L225), [annotations/tasks.py](../src/tarel/annotations/tasks.py#L238) |
| `invalid_annotation_scope` | [annotations/review.py](../src/tarel/annotations/review.py#L211), [tarel/cli.py](../src/tarel/cli.py#L3231) |
...
| `invalid_batch_size` | [tarel/application.py](../src/tarel/application.py#L1634), [retrieval/index.py](../src/tarel/retrieval/index.py#L67), [retrieval/local.py](../src/tarel/retrieval/local.py#L222) |
...
| `invalid_config` | [tarel/application.py](../src/tarel/application.py#L301), [tarel/application.py](../src/tarel/application.py#L319), [tarel/application.py](../src/tarel/application.py#L341), [tarel/application.py](../src/tarel/application.py#L370), [tarel/application.py](../src/tarel/application.py#L2388), [tarel/application.py](../src/tarel/application.py#L2405), [tarel/application.py](../src/tarel/application.py#L2444), [providers/config.py](../src/tarel/providers/config.py#L286), [providers/config.py](../src/tarel/providers/config.py#L289), [providers/config.py](../src/tarel/providers/config.py#L408) |
...
| `invalid_content_type` | [ui/server.py](../src/tarel/ui/server.py#L1008) |
...
| `invalid_context_selection` | [ui/query_tools.py](../src/tarel/ui/query_tools.py#L209), [ui/query_tools.py](../src/tarel/ui/query_tools.py#L211) |
...
| `invalid_focus_scope` | [tarel/application.py](../src/tarel/application.py#L1743) |
...
| `invalid_knowledge_scope` | [tarel/application.py](../src/tarel/application.py#L2335), [knowledge/contracts.py](../src/tarel/knowledge/contracts.py#L40), [knowledge/contracts.py](../src/tarel/knowledge/contracts.py#L47), [knowledge/contracts.py](../src/tarel/knowledge/contracts.py#L51), [knowledge/contracts.py](../src/tarel/knowledge/contracts.py#L280), [knowledge/contracts.py](../src/tarel/knowledge/contracts.py#L283), [knowledge/contracts.py](../src/tarel/knowledge/contracts.py#L290), [knowledge/contracts.py](../src/tarel/knowledge/contracts.py#L295), [knowledge/contracts.py](../src/tarel/knowledge/contracts.py#L301), [knowledge/contracts.py](../src/tarel/knowledge/contracts.py#L306), [knowledge/contracts.py](../src/tarel/knowledge/contracts.py#L311) |
...
| `invalid_object_family_mode` | [object_families/application.py](../src/tarel/object_families/application.py#L495), [ui/presentation.py](../src/tarel/ui/presentation.py#L144), [ui/server.py](../src/tarel/ui/server.py#L528) |
...
| `invalid_object_reference` | [tarel/application.py](../src/tarel/application.py#L1557), [tarel/cli.py](../src/tarel/cli.py#L2518), [workspaces/core.py](../src/tarel/workspaces/core.py#L385), [workspaces/scope.py](../src/tarel/workspaces/scope.py#L179) |
...
| `invalid_optional_request` | [ui/server.py](../src/tarel/ui/server.py#L384), [ui/server.py](../src/tarel/ui/server.py#L465), [ui/server.py](../src/tarel/ui/server.py#L468), [ui/server.py](../src/tarel/ui/server.py#L532) |
...
| `invalid_query` | [ui/query_tools.py](../src/tarel/ui/query_tools.py#L371) |
| `invalid_query_budget` | [ui/query_tools.py](../src/tarel/ui/query_tools.py#L227), [ui/query_tools.py](../src/tarel/ui/query_tools.py#L380) |
...
| `invalid_query_policy` | [ui/query_tools.py](../src/tarel/ui/query_tools.py#L150), [ui/query_tools.py](../src/tarel/ui/query_tools.py#L158), [ui/query_tools.py](../src/tarel/ui/query_tools.py#L216), [ui/query_tools.py](../src/tarel/ui/query_tools.py#L221) |
| `invalid_query_request` | [ui/query_tools.py](../src/tarel/ui/query_tools.py#L203), [ui/query_tools.py](../src/tarel/ui/query_tools.py#L362), [ui/query_tools.py](../src/tarel/ui/query_tools.py#L391), [ui/query_tools.py](../src/tarel/ui/query_tools.py#L393), [ui/server.py](../src/tarel/ui/server.py#L485) |
| `invalid_query_scope` | [ui/query_tools.py](../src/tarel/ui/query_tools.py#L70), [ui/query_tools.py](../src/tarel/ui/query_tools.py#L75), [ui/query_tools.py](../src/tarel/ui/query_tools.py#L77), [ui/query_tools.py](../src/tarel/ui/query_tools.py#L82), [ui/query_tools.py](../src/tarel/ui/query_tools.py#L84), [ui/query_tools.py](../src/tarel/ui/query_tools.py#L413), [ui/query_tools.py](../src/tarel/ui/query_tools.py#L421) |
...
| `invalid_request` | [ui/server.py](../src/tarel/ui/server.py#L959), [ui/server.py](../src/tarel/ui/server.py#L964), [ui/server.py](../src/tarel/ui/server.py#L1021), [ui/server.py](../src/tarel/ui/server.py#L1204), [ui/server.py](../src/tarel/ui/server.py#L1225), [ui/server.py](../src/tarel/ui/server.py#L1233), [ui/server.py](../src/tarel/ui/server.py#L1240), [ui/server.py](../src/tarel/ui/server.py#L1249), [ui/server.py](../src/tarel/ui/server.py#L1256), [ui/server.py](../src/tarel/ui/server.py#L1270) |
...
| `invalid_session` | [ui/server.py](../src/tarel/ui/server.py#L1005) |
...
| `invalid_workspace_scope` | [tarel/cli.py](../src/tarel/cli.py#L1894), [tarel/cli.py](../src/tarel/cli.py#L1951), [tarel/cli.py](../src/tarel/cli.py#L1997), [tarel/cli.py](../src/tarel/cli.py#L2042) |
...
| `knowledge_scope_not_found` | [tarel/application.py](../src/tarel/application.py#L2303), [tarel/application.py](../src/tarel/application.py#L2328) |
| `knowledge_source_not_found` | [tarel/application.py](../src/tarel/application.py#L1846) |
| `knowledge_workspace_required` | [tarel/application.py](../src/tarel/application.py#L2294) |
...
| `missing_api_key` | [tarel/application.py](../src/tarel/application.py#L439), [tarel/cli.py](../src/tarel/cli.py#L2891), [providers/config.py](../src/tarel/providers/config.py#L126) |
| `missing_config` | [tarel/application.py](../src/tarel/application.py#L2433) |
...
| `object_outside_scope` | [tarel/application.py](../src/tarel/application.py#L1155), [tarel/application.py](../src/tarel/application.py#L1191), [tarel/application.py](../src/tarel/application.py#L1562), [workspaces/scope.py](../src/tarel/workspaces/scope.py#L188) |
| `optional_metadata_too_large` | [ui/optional_metadata.py](../src/tarel/ui/optional_metadata.py#L157) |
| `optional_object_outside_scope` | [ui/optional_metadata.py](../src/tarel/ui/optional_metadata.py#L67), [ui/server.py](../src/tarel/ui/server.py#L375) |
...
| `proposal_not_found` | [tarel/cli.py](../src/tarel/cli.py#L3328) |
...
| `query_revision_required` | [ui/query_tools.py](../src/tarel/ui/query_tools.py#L438) |
...
| `schema_not_found` | [workspaces/core.py](../src/tarel/workspaces/core.py#L320), [workspaces/scope.py](../src/tarel/workspaces/scope.py#L323) |
...
| `semantic_import_outside_scope` | [ui/server.py](../src/tarel/ui/server.py#L612) |
...
| `small_domain_values_without_profile` | [tarel/application.py](../src/tarel/application.py#L2194) |
...
| `stale_graph` | [ui/server.py](../src/tarel/ui/server.py#L810) |
...
| `stale_object_family_scope` | [ui/server.py](../src/tarel/ui/server.py#L566) |
| `stale_optional_scope` | [ui/server.py](../src/tarel/ui/server.py#L371) |
...
| `stale_query_scope` | [ui/query_tools.py](../src/tarel/ui/query_tools.py#L333), [ui/query_tools.py](../src/tarel/ui/query_tools.py#L456) |
...
| `stale_workspace` | [ui/server.py](../src/tarel/ui/server.py#L871) |
| `system_not_found` | [workspaces/core.py](../src/tarel/workspaces/core.py#L254), [workspaces/scope.py](../src/tarel/workspaces/scope.py#L261) |
...
| `target_not_found` | [annotations/tasks.py](../src/tarel/annotations/tasks.py#L119) |
| `ui_operation_failed` | [ui/server.py](../src/tarel/ui/server.py#L1205) |
| `ui_source_required` | [ui/server.py](../src/tarel/ui/server.py#L837), [ui/server.py](../src/tarel/ui/server.py#L1102) |
...
| `unsupported_capability` | [tarel/application.py](../src/tarel/application.py#L377), [tarel/application.py](../src/tarel/application.py#L2413) |
...
| `workspace_required` | [ui/server.py](../src/tarel/ui/server.py#L819) |
...
| `zone_object_not_found` | [ui/server.py](../src/tarel/ui/server.py#L975) |
