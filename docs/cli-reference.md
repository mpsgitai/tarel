...
| `config_not_found` | [tarel/application.py](../src/tarel/application.py#L2416) |
| `conflicting_annotation_filter` | [annotations/states.py](../src/tarel/annotations/states.py#L19) |
| `conflicting_annotation_samples` | [tarel/application.py](../src/tarel/application.py#L2214) |
| `conflicting_workspace_scope` | [sdk/client.py](../src/tarel/sdk/client.py#L2706), [sdk/client.py](../src/tarel/sdk/client.py#L2726), [sdk/client.py](../src/tarel/sdk/client.py#L2740) |
...
| `duplicate_focus_source` | [tarel/application.py](../src/tarel/application.py#L2512) |
...
| `focus_stale` | [tarel/application.py](../src/tarel/application.py#L2496), [focus/core.py](../src/tarel/focus/core.py#L118), [ui/server.py](../src/tarel/ui/server.py#L738) |
...
| `graph_outside_focus` | [tarel/application.py](../src/tarel/application.py#L1784) |
...
| `invalid_annotation_limit` | [tarel/application.py](../src/tarel/application.py#L1999) |
...
| `invalid_annotation_scope` | [annotations/review.py](../src/tarel/annotations/review.py#L211), [tarel/cli.py](../src/tarel/cli.py#L3288) |
...
| `invalid_batch_size` | [tarel/application.py](../src/tarel/application.py#L1664), [retrieval/index.py](../src/tarel/retrieval/index.py#L67), [retrieval/local.py](../src/tarel/retrieval/local.py#L222) |
...
| `invalid_config` | [tarel/application.py](../src/tarel/application.py#L308), [tarel/application.py](../src/tarel/application.py#L326), [tarel/application.py](../src/tarel/application.py#L348), [tarel/application.py](../src/tarel/application.py#L377), [tarel/application.py](../src/tarel/application.py#L2418), [tarel/application.py](../src/tarel/application.py#L2435), [tarel/application.py](../src/tarel/application.py#L2474), [providers/config.py](../src/tarel/providers/config.py#L286), [providers/config.py](../src/tarel/providers/config.py#L289), [providers/config.py](../src/tarel/providers/config.py#L408) |
...
| `invalid_context_packet` | [tarel/context_guidance.py](../src/tarel/context_guidance.py#L500), [tarel/context_guidance.py](../src/tarel/context_guidance.py#L549), [tarel/context_guidance.py](../src/tarel/context_guidance.py#L565), [tarel/context_guidance.py](../src/tarel/context_guidance.py#L612), [tarel/context_guidance.py](../src/tarel/context_guidance.py#L620), [tarel/context_guidance.py](../src/tarel/context_guidance.py#L628), [tarel/context_guidance.py](../src/tarel/context_guidance.py#L636), [tarel/context_packets.py](../src/tarel/context_packets.py#L127), [tarel/context_packets.py](../src/tarel/context_packets.py#L132), [tarel/context_packets.py](../src/tarel/context_packets.py#L294), [tarel/context_packets.py](../src/tarel/context_packets.py#L304), [tarel/context_packets.py](../src/tarel/context_packets.py#L311), [tarel/context_packets.py](../src/tarel/context_packets.py#L317), [tarel/context_packets.py](../src/tarel/context_packets.py#L322), [tarel/context_packets.py](../src/tarel/context_packets.py#L351), [tarel/context_packets.py](../src/tarel/context_packets.py#L355), [tarel/context_packets.py](../src/tarel/context_packets.py#L369), [tarel/context_packets.py](../src/tarel/context_packets.py#L375) |
...
| `invalid_focus_scope` | [tarel/application.py](../src/tarel/application.py#L1773) |
...
| `invalid_grounding_limit` | [sdk/client.py](../src/tarel/sdk/client.py#L1384) |
| `invalid_grounding_scope` | [sdk/client.py](../src/tarel/sdk/client.py#L1295), [sdk/client.py](../src/tarel/sdk/client.py#L1323), [sdk/client.py](../src/tarel/sdk/client.py#L1334), [sdk/client.py](../src/tarel/sdk/client.py#L1445), [sdk/client.py](../src/tarel/sdk/client.py#L1451) |
...
| `invalid_knowledge_scope` | [tarel/application.py](../src/tarel/application.py#L2365), [knowledge/contracts.py](../src/tarel/knowledge/contracts.py#L40), [knowledge/contracts.py](../src/tarel/knowledge/contracts.py#L47), [knowledge/contracts.py](../src/tarel/knowledge/contracts.py#L51), [knowledge/contracts.py](../src/tarel/knowledge/contracts.py#L280), [knowledge/contracts.py](../src/tarel/knowledge/contracts.py#L283), [knowledge/contracts.py](../src/tarel/knowledge/contracts.py#L290), [knowledge/contracts.py](../src/tarel/knowledge/contracts.py#L295), [knowledge/contracts.py](../src/tarel/knowledge/contracts.py#L301), [knowledge/contracts.py](../src/tarel/knowledge/contracts.py#L306), [knowledge/contracts.py](../src/tarel/knowledge/contracts.py#L311) |
| `invalid_knowledge_source` | [tarel/application.py](../src/tarel/application.py#L1881) |
...
| `invalid_object_reference` | [tarel/application.py](../src/tarel/application.py#L1564), [tarel/cli.py](../src/tarel/cli.py#L2546), [workspaces/core.py](../src/tarel/workspaces/core.py#L385), [workspaces/scope.py](../src/tarel/workspaces/scope.py#L179) |
...
| `invalid_query_request` | [ui/query_tools.py](../src/tarel/ui/query_tools.py#L206), [ui/query_tools.py](../src/tarel/ui/query_tools.py#L381), [ui/query_tools.py](../src/tarel/ui/query_tools.py#L410), [ui/query_tools.py](../src/tarel/ui/query_tools.py#L412), [ui/server.py](../src/tarel/ui/server.py#L485) |
...
| `invalid_sample_limit` | [tarel/application.py](../src/tarel/application.py#L2212), [sqlite/connector.py](../src/tarel/connectors/sqlite/connector.py#L97), [sqlserver/connector.py](../src/tarel/connectors/sqlserver/connector.py#L345), [sources/application.py](../src/tarel/sources/application.py#L247) |
...
| `invalid_workspace_scope` | [tarel/cli.py](../src/tarel/cli.py#L1914), [tarel/cli.py](../src/tarel/cli.py#L1971), [tarel/cli.py](../src/tarel/cli.py#L2017), [tarel/cli.py](../src/tarel/cli.py#L2062) |
...
| `knowledge_exists` | [tarel/application.py](../src/tarel/application.py#L1863) |
| `knowledge_graph_outside_workspace` | [tarel/application.py](../src/tarel/application.py#L2379) |
...
| `knowledge_scope_not_found` | [tarel/application.py](../src/tarel/application.py#L2333), [tarel/application.py](../src/tarel/application.py#L2358) |
| `knowledge_source_not_found` | [tarel/application.py](../src/tarel/application.py#L1876) |
| `knowledge_workspace_required` | [tarel/application.py](../src/tarel/application.py#L2324) |
...
| `missing_api_key` | [tarel/application.py](../src/tarel/application.py#L446), [tarel/cli.py](../src/tarel/cli.py#L2948), [providers/config.py](../src/tarel/providers/config.py#L126) |
| `missing_config` | [tarel/application.py](../src/tarel/application.py#L2463) |
...
| `proposal_not_found` | [tarel/cli.py](../src/tarel/cli.py#L3388) |
...
| `small_domain_values_without_profile` | [tarel/application.py](../src/tarel/application.py#L2224) |
...
| `stale_knowledge_reference` | [tarel/application.py](../src/tarel/application.py#L2403) |
...
| `unsupported_capability` | [tarel/application.py](../src/tarel/application.py#L384), [tarel/application.py](../src/tarel/application.py#L2443) |
...
| `unsupported_knowledge_format` | [tarel/application.py](../src/tarel/application.py#L1869) |
