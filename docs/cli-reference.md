...
Starts a local browser server. --edit enables explicit mutations. Opening the UI does not itself run a connector or LLM. UI display filters are not automatically context-packet constraints. --architecture-file opts an unfiltered workspace into the experimental [architecture browser](architecture-ui.md). --architecture-edit enables only sidecar edits, independently of --edit; no architecture connections become technical lineage.
...
tarel ui [-h] [--workspace WORKSPACE] [--system SYSTEMS] [--graph GRAPHS] [--area AREAS]
                ...
                [--threads N_THREADS] [--architecture-file ARCHITECTURE_FILE] [--architecture-edit]
                [graph]
```
...
| `--search-mode` | text; `lexical`, `bm25`, `vector`, `hybrid` | optional | `bm25` | Local metadata search mode; BM25 needs no model index. |
| `--model` | Path | optional | not set | Local embedding model path. |
| `--threads` | int | optional | not set | Local model thread count. |
| `--architecture-file` | Path | optional | not set | Experimental local architecture sidecar. |
| `--architecture-edit` | flag | optional | `False` | Edit architecture only, not graph annotations. |
...
tarel search [-h] [--namespace NAMESPACE] [--limit LIMIT]
                    ...
                    [--bm25-weight BM25_WEIGHT] [--workspace] [--system SYSTEMS] [--graph GRAPHS]
                    [--area AREAS] [--scope-schema SCHEMAS] [--zone ZONES]
                    [--scope-object SCOPE_OBJECTS] [--focus FOCUSES] [--type {table,view}]
                    [--role ROLES] [--has-field REQUIRED_FIELDS]
                    [--annotation-state {draft,validated,rejected,deferred,review_required}]
                    [--validated-only] [--format {text,json}]
                    name query
```
...
| `--model` | Path | optional | not set | Local embedding model path. |
| `--threads` | int | optional | not set | Local model thread count. |
| `--bm25-weight` | float | optional | not set | Hybrid BM25 weight; default 1.0. |
...
| `--scope-object` | text | optional; repeatable | not set | Hard workspace boundary as GRAPH:OBJECT_ID; repeat for a union. |
| `--focus` | text | optional; repeatable | not set | Limit a workspace operation to a current saved focus; repeat for a union. |
| `--type` | text; `table`, `view` | optional; repeatable | not set | Physical object types used to filter candidates before ranking. |
| `--role` | text | optional; repeatable | not set | Documented semantic roles used to filter candidates before ranking. |
| `--has-field` | text | optional; repeatable | not set | Field names every candidate object must contain. |
| `--annotation-state` | text; `draft`, `validated`, `rejected`, `deferred`, `review_required` | optional; repeatable | not set | Include semantic annotations in one or more review states. |
| `--validated-only` | flag | optional | `False` | Include only human-validated semantic annotations. |
| `--format` | text; `text`, `json` | optional | `text` | Output format (default: text). |
...
tarel context build [-h] [--namespace NAMESPACE] [--seed-limit SEED_LIMIT]
                           ...
                           [--model MODEL_PATH] [--threads N_THREADS] [--bm25-weight BM25_WEIGHT]
                           [--workspace] [--system SYSTEMS] [--graph GRAPHS] [--area AREAS]
                           [--scope-schema SCHEMAS] [--zone ZONES] [--scope-object SCOPE_OBJECTS]
                           [--focus FOCUSES] [--object OBJECT_IDS]
                           [--annotation-state {draft,validated,rejected,deferred,review_required}]
                           [--validated-only]
...
| `--scope-object` | text | optional; repeatable | not set | Hard workspace boundary as GRAPH:OBJECT_ID; repeat for a union. |
| `--focus` | text | optional; repeatable | not set | Limit a workspace operation to a current saved focus; repeat for a union. |
| `--object` | text | optional; repeatable | not set | Use an exact OBJECT_ID, or GRAPH:OBJECT_ID with --workspace; repeat as needed. |
| `--annotation-state` | text; `draft`, `validated`, `rejected`, `deferred`, `review_required` | optional; repeatable | not set | Include semantic annotations in one or more review states. |
| `--validated-only` | flag | optional | `False` | Include only human-validated semantic annotations. |
...
tarel context prefix [-h] [--namespace NAMESPACE] [--max-objects MAX_OBJECTS]
                            ...
                            [--scope-object SCOPE_OBJECTS] [--focus FOCUSES]
                            [--annotation-state {draft,validated,rejected,deferred,review_required}]
                            [--validated-only]
                            [--logical-hints {confirmed_only,confirmed_then_candidates,include_candidates}]
                            [--format {text,json}]
...
| `ambiguous_scope_selector` | [workspaces/scope.py](../src/tarel/workspaces/scope.py#L284) |
...
| `architecture_required` | [ui/server.py](../src/tarel/ui/server.py#L147) |
| `architecture_scope` | [ui/server.py](../src/tarel/ui/server.py#L151) |
| `architecture_unavailable` | [ui/server.py](../src/tarel/ui/server.py#L453) |
...
| `config_not_found` | [tarel/application.py](../src/tarel/application.py#L2376) |
| `conflicting_annotation_filter` | [annotations/states.py](../src/tarel/annotations/states.py#L19) |
| `conflicting_annotation_samples` | [tarel/application.py](../src/tarel/application.py#L2174) |
...
| `context_object_not_found` | [tarel/context.py](../src/tarel/context.py#L254) |
...
| `duplicate_focus` | [ui/server.py](../src/tarel/ui/server.py#L725) |
| `duplicate_focus_source` | [tarel/application.py](../src/tarel/application.py#L2472) |
...
| `empty_query` | [tarel/search.py](../src/tarel/search.py#L219) |
| `empty_zone` | [ui/server.py](../src/tarel/ui/server.py#L863) |
...
| `focus_outside_scope` | [ui/server.py](../src/tarel/ui/server.py#L729) |
| `focus_save_failed` | [focus/store.py](../src/tarel/focus/store.py#L39) |
| `focus_stale` | [tarel/application.py](../src/tarel/application.py#L2456), [focus/core.py](../src/tarel/focus/core.py#L118), [ui/server.py](../src/tarel/ui/server.py#L737) |
...
| `graph_exists` | [tarel/application.py](../src/tarel/application.py#L530) |
...
| `graph_outside_focus` | [tarel/application.py](../src/tarel/application.py#L1744) |
| `graph_outside_scope` | [ui/server.py](../src/tarel/ui/server.py#L852), [ui/server.py](../src/tarel/ui/server.py#L951), [workspaces/scope.py](../src/tarel/workspaces/scope.py#L101), [workspaces/scope.py](../src/tarel/workspaces/scope.py#L306) |
...
| `graph_required` | [ui/server.py](../src/tarel/ui/server.py#L847) |
...
| `invalid_annotation_limit` | [tarel/application.py](../src/tarel/application.py#L1959) |
...
| `invalid_annotation_scope` | [annotations/review.py](../src/tarel/annotations/review.py#L186), [tarel/cli.py](../src/tarel/cli.py#L3215) |
...
| `invalid_batch_size` | [tarel/application.py](../src/tarel/application.py#L1624), [retrieval/index.py](../src/tarel/retrieval/index.py#L67), [retrieval/local.py](../src/tarel/retrieval/local.py#L222) |
...
| `invalid_config` | [tarel/application.py](../src/tarel/application.py#L301), [tarel/application.py](../src/tarel/application.py#L319), [tarel/application.py](../src/tarel/application.py#L341), [tarel/application.py](../src/tarel/application.py#L370), [tarel/application.py](../src/tarel/application.py#L2378), [tarel/application.py](../src/tarel/application.py#L2395), [tarel/application.py](../src/tarel/application.py#L2434), [providers/config.py](../src/tarel/providers/config.py#L286), [providers/config.py](../src/tarel/providers/config.py#L289), [providers/config.py](../src/tarel/providers/config.py#L408) |
...
| `invalid_content_type` | [ui/server.py](../src/tarel/ui/server.py#L1007) |
...
| `invalid_context_selection` | [ui/query_tools.py](../src/tarel/ui/query_tools.py#L208), [ui/query_tools.py](../src/tarel/ui/query_tools.py#L210) |
...
| `invalid_focus_scope` | [tarel/application.py](../src/tarel/application.py#L1733) |
...
| `invalid_grounding_limit` | [sdk/client.py](../src/tarel/sdk/client.py#L1361) |
| `invalid_grounding_scope` | [sdk/client.py](../src/tarel/sdk/client.py#L1272), [sdk/client.py](../src/tarel/sdk/client.py#L1300), [sdk/client.py](../src/tarel/sdk/client.py#L1311), [sdk/client.py](../src/tarel/sdk/client.py#L1422), [sdk/client.py](../src/tarel/sdk/client.py#L1428) |
...
| `invalid_knowledge_scope` | [tarel/application.py](../src/tarel/application.py#L2325), [knowledge/contracts.py](../src/tarel/knowledge/contracts.py#L40), [knowledge/contracts.py](../src/tarel/knowledge/contracts.py#L47), [knowledge/contracts.py](../src/tarel/knowledge/contracts.py#L51), [knowledge/contracts.py](../src/tarel/knowledge/contracts.py#L280), [knowledge/contracts.py](../src/tarel/knowledge/contracts.py#L283), [knowledge/contracts.py](../src/tarel/knowledge/contracts.py#L290), [knowledge/contracts.py](../src/tarel/knowledge/contracts.py#L295), [knowledge/contracts.py](../src/tarel/knowledge/contracts.py#L301), [knowledge/contracts.py](../src/tarel/knowledge/contracts.py#L306), [knowledge/contracts.py](../src/tarel/knowledge/contracts.py#L311) |
| `invalid_knowledge_source` | [tarel/application.py](../src/tarel/application.py#L1841) |
| `invalid_knowledge_state` | [knowledge/contracts.py](../src/tarel/knowledge/contracts.py#L266) |
| `invalid_limit` | [tarel/application.py](../src/tarel/application.py#L1006), [retrieval/index.py](../src/tarel/retrieval/index.py#L353), [tarel/search.py](../src/tarel/search.py#L216) |
...
| `invalid_object_family_mode` | [object_families/application.py](../src/tarel/object_families/application.py#L495), [ui/presentation.py](../src/tarel/ui/presentation.py#L144), [ui/server.py](../src/tarel/ui/server.py#L527) |
...
| `invalid_object_reference` | [tarel/application.py](../src/tarel/application.py#L1547), [tarel/cli.py](../src/tarel/cli.py#L2506), [workspaces/core.py](../src/tarel/workspaces/core.py#L385), [workspaces/scope.py](../src/tarel/workspaces/scope.py#L179) |
...
| `invalid_optional_request` | [ui/server.py](../src/tarel/ui/server.py#L383), [ui/server.py](../src/tarel/ui/server.py#L464), [ui/server.py](../src/tarel/ui/server.py#L467), [ui/server.py](../src/tarel/ui/server.py#L531) |
...
| `invalid_port` | [ui/server.py](../src/tarel/ui/server.py#L1099) |
| `invalid_profile_row_limit` | [tarel/application.py](../src/tarel/application.py#L2179), [sqlite/connector.py](../src/tarel/connectors/sqlite/connector.py#L205), [sqlite/connector.py](../src/tarel/connectors/sqlite/connector.py#L377), [sqlserver/connector.py](../src/tarel/connectors/sqlserver/connector.py#L520), [sqlserver/connector.py](../src/tarel/connectors/sqlserver/connector.py#L792), [sources/application.py](../src/tarel/sources/application.py#L242) |
| `invalid_proposal` | [annotations/apply.py](../src/tarel/annotations/apply.py#L46), [annotations/contracts.py](../src/tarel/annotations/contracts.py#L77), [annotations/contracts.py](../src/tarel/annotations/contracts.py#L102), [annotations/contracts.py](../src/tarel/annotations/contracts.py#L105), [annotations/contracts.py](../src/tarel/annotations/contracts.py#L112), [annotations/contracts.py](../src/tarel/annotations/contracts.py#L136), [annotations/contracts.py](../src/tarel/annotations/contracts.py#L152), [annotations/contracts.py](../src/tarel/annotations/contracts.py#L156), [annotations/contracts.py](../src/tarel/annotations/contracts.py#L171), [annotations/contracts.py](../src/tarel/annotations/contracts.py#L179), [annotations/contracts.py](../src/tarel/annotations/contracts.py#L185), [annotations/contracts.py](../src/tarel/annotations/contracts.py#L194), [annotations/contracts.py](../src/tarel/annotations/contracts.py#L197), [tarel/cli.py](../src/tarel/cli.py#L3317), [tarel/cli.py](../src/tarel/cli.py#L3319) |
| `invalid_provider_adapter` | [tarel/application.py](../src/tarel/application.py#L434), [providers/config.py](../src/tarel/providers/config.py#L106), [providers/config.py](../src/tarel/providers/config.py#L198), [providers/config.py](../src/tarel/providers/config.py#L352), [providers/host.py](../src/tarel/providers/host.py#L61), [providers/host.py](../src/tarel/providers/host.py#L66) |
| `invalid_provider_config` | [tarel/application.py](../src/tarel/application.py#L462), [providers/config.py](../src/tarel/providers/config.py#L121), [providers/config.py](../src/tarel/providers/config.py#L161), [providers/config.py](../src/tarel/providers/config.py#L315), [providers/config.py](../src/tarel/providers/config.py#L361), [providers/config.py](../src/tarel/providers/config.py#L370), [providers/config.py](../src/tarel/providers/config.py#L379), [providers/config.py](../src/tarel/providers/config.py#L389), [providers/config.py](../src/tarel/providers/config.py#L419) |
...
| `invalid_provider_response` | [tarel/application.py](../src/tarel/application.py#L495), [discovery/application.py](../src/tarel/discovery/application.py#L705), [discovery/application.py](../src/tarel/discovery/application.py#L713), [discovery/application.py](../src/tarel/discovery/application.py#L721), [providers/openai_compatible.py](../src/tarel/providers/openai_compatible.py#L99), [providers/openrouter.py](../src/tarel/providers/openrouter.py#L78), [providers/openrouter.py](../src/tarel/providers/openrouter.py#L89), [providers/openrouter.py](../src/tarel/providers/openrouter.py#L108), [providers/openrouter.py](../src/tarel/providers/openrouter.py#L135), [providers/openrouter.py](../src/tarel/providers/openrouter.py#L140) |
| `invalid_query` | [ui/query_tools.py](../src/tarel/ui/query_tools.py#L367) |
| `invalid_query_budget` | [ui/query_tools.py](../src/tarel/ui/query_tools.py#L226), [ui/query_tools.py](../src/tarel/ui/query_tools.py#L376) |
...
| `invalid_query_policy` | [ui/query_tools.py](../src/tarel/ui/query_tools.py#L149), [ui/query_tools.py](../src/tarel/ui/query_tools.py#L157), [ui/query_tools.py](../src/tarel/ui/query_tools.py#L215), [ui/query_tools.py](../src/tarel/ui/query_tools.py#L220) |
| `invalid_query_request` | [ui/query_tools.py](../src/tarel/ui/query_tools.py#L202), [ui/query_tools.py](../src/tarel/ui/query_tools.py#L358), [ui/query_tools.py](../src/tarel/ui/query_tools.py#L385), [ui/query_tools.py](../src/tarel/ui/query_tools.py#L387), [ui/server.py](../src/tarel/ui/server.py#L484) |
| `invalid_query_scope` | [ui/query_tools.py](../src/tarel/ui/query_tools.py#L69), [ui/query_tools.py](../src/tarel/ui/query_tools.py#L74), [ui/query_tools.py](../src/tarel/ui/query_tools.py#L76), [ui/query_tools.py](../src/tarel/ui/query_tools.py#L81), [ui/query_tools.py](../src/tarel/ui/query_tools.py#L83), [ui/query_tools.py](../src/tarel/ui/query_tools.py#L403), [ui/query_tools.py](../src/tarel/ui/query_tools.py#L411) |
...
| `invalid_relationship` | [tarel/context.py](../src/tarel/context.py#L623), [tarel/context.py](../src/tarel/context.py#L656), [tarel/context.py](../src/tarel/context.py#L667), [tarel/context.py](../src/tarel/context.py#L690) |
...
| `invalid_request` | [ui/server.py](../src/tarel/ui/server.py#L958), [ui/server.py](../src/tarel/ui/server.py#L963), [ui/server.py](../src/tarel/ui/server.py#L1020), [ui/server.py](../src/tarel/ui/server.py#L1198), [ui/server.py](../src/tarel/ui/server.py#L1219), [ui/server.py](../src/tarel/ui/server.py#L1227), [ui/server.py](../src/tarel/ui/server.py#L1234), [ui/server.py](../src/tarel/ui/server.py#L1243), [ui/server.py](../src/tarel/ui/server.py#L1250), [ui/server.py](../src/tarel/ui/server.py#L1264) |
...
| `invalid_sample_limit` | [tarel/application.py](../src/tarel/application.py#L2172), [sqlite/connector.py](../src/tarel/connectors/sqlite/connector.py#L97), [sqlserver/connector.py](../src/tarel/connectors/sqlserver/connector.py#L345), [sources/application.py](../src/tarel/sources/application.py#L247) |
| `invalid_schema_reference` | [workspaces/core.py](../src/tarel/workspaces/core.py#L244), [workspaces/scope.py](../src/tarel/workspaces/scope.py#L301) |
...
| `invalid_session` | [ui/server.py](../src/tarel/ui/server.py#L1004) |
...
| `knowledge_exists` | [tarel/application.py](../src/tarel/application.py#L1823) |
| `knowledge_graph_outside_workspace` | [tarel/application.py](../src/tarel/application.py#L2339) |
...
| `knowledge_scope_not_found` | [tarel/application.py](../src/tarel/application.py#L2293), [tarel/application.py](../src/tarel/application.py#L2318) |
| `knowledge_source_not_found` | [tarel/application.py](../src/tarel/application.py#L1836) |
| `knowledge_workspace_required` | [tarel/application.py](../src/tarel/application.py#L2284) |
...
| `lineage_required` | [ui/server.py](../src/tarel/ui/server.py#L586) |
...
| `missing_api_key` | [tarel/application.py](../src/tarel/application.py#L439), [tarel/cli.py](../src/tarel/cli.py#L2879), [providers/config.py](../src/tarel/providers/config.py#L126) |
| `missing_config` | [tarel/application.py](../src/tarel/application.py#L2423) |
...
| `missing_focus_sources` | [tarel/application.py](../src/tarel/application.py#L616) |
...
| `missing_provider_adapter` | [tarel/application.py](../src/tarel/application.py#L428) |
...
| `object_outside_scope` | [tarel/application.py](../src/tarel/application.py#L1150), [tarel/application.py](../src/tarel/application.py#L1186), [tarel/application.py](../src/tarel/application.py#L1552), [workspaces/scope.py](../src/tarel/workspaces/scope.py#L188) |
| `optional_metadata_too_large` | [ui/optional_metadata.py](../src/tarel/ui/optional_metadata.py#L157) |
| `optional_object_outside_scope` | [ui/optional_metadata.py](../src/tarel/ui/optional_metadata.py#L67), [ui/server.py](../src/tarel/ui/server.py#L374) |
...
| `proposal_not_found` | [tarel/cli.py](../src/tarel/cli.py#L3312) |
...
| `query_revision_required` | [ui/query_tools.py](../src/tarel/ui/query_tools.py#L428) |
| `raw_samples_not_allowed` | [sources/application.py](../src/tarel/sources/application.py#L252) |
| `read_only` | [ui/server.py](../src/tarel/ui/server.py#L802) |
...
| `reference_mapping_field_not_found` | [tarel/context_hints_application.py](../src/tarel/context_hints_application.py#L258), [reference_mapping/application.py](../src/tarel/reference_mapping/application.py#L375), [reference_mapping/application.py](../src/tarel/reference_mapping/application.py#L391), [reference_mapping/application.py](../src/tarel/reference_mapping/application.py#L404), [ui/presentation.py](../src/tarel/ui/presentation.py#L1170), [ui/presentation.py](../src/tarel/ui/presentation.py#L1184) |
...
| `request_too_large` | [ui/server.py](../src/tarel/ui/server.py#L1017) |
...
| `route_not_found` | [ui/server.py](../src/tarel/ui/server.py#L700), [ui/server.py](../src/tarel/ui/server.py#L798) |
...
| `schema_not_found` | [workspaces/core.py](../src/tarel/workspaces/core.py#L320), [workspaces/scope.py](../src/tarel/workspaces/scope.py#L316) |
| `selected_objects_exceed_budget` | [tarel/context.py](../src/tarel/context.py#L239), [tarel/context.py](../src/tarel/context.py#L244), [tarel/context.py](../src/tarel/context.py#L288) |
...
| `semantic_import_outside_scope` | [ui/server.py](../src/tarel/ui/server.py#L611) |
...
| `small_domain_values_without_profile` | [tarel/application.py](../src/tarel/application.py#L2184) |
...
| `stale_graph` | [ui/server.py](../src/tarel/ui/server.py#L809) |
...
| `stale_knowledge_reference` | [tarel/application.py](../src/tarel/application.py#L2363) |
...
| `stale_logical_metadata_scope` | [ui/server.py](../src/tarel/ui/server.py#L516) |
...
| `stale_object_family_scope` | [ui/server.py](../src/tarel/ui/server.py#L565) |
| `stale_optional_scope` | [ui/server.py](../src/tarel/ui/server.py#L370) |
| `stale_proposal` | [annotations/apply.py](../src/tarel/annotations/apply.py#L29) |
| `stale_query_scope` | [ui/query_tools.py](../src/tarel/ui/query_tools.py#L329), [ui/query_tools.py](../src/tarel/ui/query_tools.py#L446) |
...
| `stale_workspace` | [ui/server.py](../src/tarel/ui/server.py#L870) |
| `system_not_found` | [workspaces/core.py](../src/tarel/workspaces/core.py#L254), [workspaces/scope.py](../src/tarel/workspaces/scope.py#L254) |
...
| `ui_operation_failed` | [ui/server.py](../src/tarel/ui/server.py#L1199) |
| `ui_source_required` | [ui/server.py](../src/tarel/ui/server.py#L836), [ui/server.py](../src/tarel/ui/server.py#L1101) |
| `unknown_demo` | [tarel/application.py](../src/tarel/application.py#L284) |
...
| `unsupported_capability` | [tarel/application.py](../src/tarel/application.py#L377), [tarel/application.py](../src/tarel/application.py#L2403) |
...
| `unsupported_knowledge_format` | [tarel/application.py](../src/tarel/application.py#L1829) |
...
| `workspace_exists` | [tarel/application.py](../src/tarel/application.py#L672) |
| `workspace_not_found` | [workspaces/store.py](../src/tarel/workspaces/store.py#L65) |
| `workspace_required` | [ui/server.py](../src/tarel/ui/server.py#L818) |
...
| `zone_object_not_found` | [ui/server.py](../src/tarel/ui/server.py#L974) |
...
```
```python
tarel.context.graph(name: 'str', query: 'str', *, namespace: 'str | None' = None, seed_limit: 'int' = 3, max_objects: 'int' = 10, max_joins: 'int' = 12, max_hops: 'int' = 2, max_fields_per_object: 'int' = 12, max_characters: 'int' = 24000, mode: 'str' = 'lexical', model_path: 'str | Path | None' = None, n_threads: 'int | None' = None, bm25_weight: 'float | None' = None, annotation_states: 'frozenset[str] | None' = None, validated_only: 'bool' = False, logical_hints: 'str | None' = None, object_ids: 'tuple[str, ...]' = (), scope_object_ids: 'tuple[str, ...]' = (), focuses: 'tuple[str, ...]' = ()) -> 'ContextResult'
```
```python
tarel.context.impact(packet: 'str | Path', *, graph: 'str') -> 'ContextPacketImpact'
```
```python
tarel.context.prefix_graph(name: 'str', *, namespace: 'str | None' = None, max_objects: 'int' = 250, max_joins: 'int' = 500, max_fields_per_object: 'int' = 50, max_characters: 'int' = 500000, annotation_states: 'frozenset[str] | None' = None, validated_only: 'bool' = False, logical_hints: 'str | None' = None, scope_object_ids: 'tuple[str, ...]' = (), focuses: 'tuple[str, ...]' = ()) -> 'ContextResult'
```
```python
tarel.context.prefix_workspace(name: 'str', *, selection: 'ScopeSelection | None' = None, systems: 'tuple[str, ...]' = (), graphs: 'tuple[str, ...]' = (), areas: 'tuple[str, ...]' = (), schemas: 'tuple[str, ...]' = (), zones: 'tuple[str, ...]' = (), focuses: 'tuple[str, ...]' = (), scope_objects: 'tuple[str, ...]' = (), max_objects: 'int' = 250, max_joins: 'int' = 500, max_fields_per_object: 'int' = 50, max_characters: 'int' = 500000, annotation_states: 'frozenset[str] | None' = None, validated_only: 'bool' = False, logical_hints: 'str | None' = None) -> 'ContextResult'
```
```python
tarel.context.split(packet: 'ContextResult') -> 'ContextCacheParts'
```
```python
tarel.context.workspace(name: 'str', query: 'str', *, selection: 'ScopeSelection | None' = None, systems: 'tuple[str, ...]' = (), graphs: 'tuple[str, ...]' = (), areas: 'tuple[str, ...]' = (), schemas: 'tuple[str, ...]' = (), zones: 'tuple[str, ...]' = (), focuses: 'tuple[str, ...]' = (), scope_objects: 'tuple[str, ...]' = (), seed_limit: 'int' = 3, max_objects: 'int' = 10, max_joins: 'int' = 12, max_hops: 'int' = 2, max_fields_per_object: 'int' = 12, max_characters: 'int' = 24000, mode: 'str' = 'lexical', model_path: 'str | Path | None' = None, n_threads: 'int | None' = None, bm25_weight: 'float | None' = None, annotation_states: 'frozenset[str] | None' = None, validated_only: 'bool' = False, logical_hints: 'str | None' = None, object_ids: 'tuple[str, ...]' = ()) -> 'ContextResult'
```
...
```python
tarel.search.graph(name: 'str', query: 'str', *, limit: 'int' = 20, namespace: 'str | None' = None, mode: 'str' = 'lexical', model_path: 'str | Path | None' = None, n_threads: 'int | None' = None, bm25_weight: 'float | None' = None, annotation_states: 'frozenset[str] | None' = None, validated_only: 'bool' = False, family_mode: 'str | None' = 'confirmed_only', filters: 'SearchFilters | None' = None, focuses: 'tuple[str, ...]' = (), scope_object_ids: 'tuple[str, ...]' = ()) -> 'SearchResults'
```
```python
tarel.search.workspace(name: 'str', query: 'str', *, selection: 'ScopeSelection | None' = None, systems: 'tuple[str, ...]' = (), graphs: 'tuple[str, ...]' = (), areas: 'tuple[str, ...]' = (), schemas: 'tuple[str, ...]' = (), zones: 'tuple[str, ...]' = (), focuses: 'tuple[str, ...]' = (), scope_objects: 'tuple[str, ...]' = (), limit: 'int' = 20, mode: 'str' = 'lexical', model_path: 'str | Path | None' = None, n_threads: 'int | None' = None, bm25_weight: 'float | None' = None, annotation_states: 'frozenset[str] | None' = None, validated_only: 'bool' = False, family_mode: 'str | None' = 'confirmed_only', filters: 'SearchFilters | None' = None) -> 'SearchResults'
```
...
```
```python
tarel.workspace.scope(name: 'str', *, selection: 'ScopeSelection | None' = None, systems: 'tuple[str, ...]' = (), graphs: 'tuple[str, ...]' = (), areas: 'tuple[str, ...]' = (), schemas: 'tuple[str, ...]' = (), zones: 'tuple[str, ...]' = (), focuses: 'tuple[str, ...]' = (), objects: 'tuple[str, ...]' = ()) -> 'ResolvedScope'
```
```python
